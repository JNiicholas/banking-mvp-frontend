          ...
          [
            {
              label: 'Actions',
              items: [
                { label: 'List Customers', icon: 'pi pi-users', command: () => this.router.navigate(['/admin/list-customers'], { skipLocationChange: true, replaceUrl: true }) },
                { label: 'New Customer', icon: 'pi pi-user-plus', command: () => this.router.navigate(['/admin/customers/new'], { skipLocationChange: true, replaceUrl: true }) },
                { label: 'New Account', icon: 'pi pi-wallet', command: () => this.router.navigate(['/admin/accounts/new'], { skipLocationChange: true, replaceUrl: true }) }
              ]
            }
          ]
        ]
